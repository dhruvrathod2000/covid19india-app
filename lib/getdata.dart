...
import 'dart:convert';
class CoronaApi {
  dynamic deaths, confirmed, recovered, active,last_updated,deltaconfirmed,deltarecovered,deltadeaths;
  Future<void> getData() async {
    try{
      ...
      confirmed=0;deaths=0;last_updated=0;active=0;recovered=0;
    }
